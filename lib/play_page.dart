...
class _PlayPageState extends State<PlayPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: _isFullScreen
          ? null
          : AppBar(
              title: Text("Que voulez-vous dire ? "),
            ),
      body: _isFullScreen
          ? Container(
    ...
    return Center(
      ...
      children: <Widget>[
        ...
        FlatButton(
          ...
          child: Icon(
            // Icone boutton flèche DROITE (suivant)
            Icons.fast_forward,
            size: 36.0,
            color: Colors.white,
          ),
          ...
          style: TextStyle(
            ...
            shadows: <Shadow>[
              Shadow(
                ...
                blurRadius: 4.0,
                color:
                    Color.fromARGB(150, 0, 0, 0), // Couleur minuteur à droite
              ),
            ],
          ),
        ),
    ...
    return Row(
      children: <Widget>[
        ...
        IconButton(
          ...
          color: Colors.yellow,
          icon: Icon(
            Icons.fullscreen, //Icone FULLSCREEN
            color: Colors.white,
          ),
  ...
  Widget _buildCard(int index) {
    ...
    if (clip.runningTime > 60) {
      runtime =
          "${clip.runningTime ~/ 60} secondes ${clip.runningTime % 60} secondes";
    } else {
      runtime = "${clip.runningTime % 60} secondes";
    }
    return Card(
      child: Container(
        padding: EdgeInsets.all(4), //Taille de la liste des conteneurs
        child: Row(
          ...
          children: <Widget>[
            Padding(
              ...
              child: Image.asset(clip.thumbPath(),
